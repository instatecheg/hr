...
const selectedCostCenter = ref(null)  // <- متغير Cost Center الجديد
const distance = ref(null)

const projects = ref([null])
const costCenters = ref([null])  // <- متغير الـ Cost Centers
...
// لو عايز تجيب الـ Cost Centers من السيرفر ممكن تعمل حاجة زي كده:
...
onMounted(() => {
  fetchProjects()
  fetchCostCenters() // <- جلب Cost Centers
})
</script>